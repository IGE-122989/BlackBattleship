...
public class UserStory11Page {
    ...
    public boolean hasGiftIconInBoard() {
        return !WebDriverRunner.getWebDriver().findElements(
                By.xpath("//app-battleship-board//*[@data-icon='gift']")).isEmpty();
    }

    /**
     * Verifica se o mecanismo de presente existe na página.
     *
     * @return true se o ícone de presente existe em algum lugar da página
     */
    public boolean hasGiftMechanismInPage() {
        return !WebDriverRunner.getWebDriver().findElements(
                By.xpath("//*[@data-icon='gift']")).isEmpty();
    }
