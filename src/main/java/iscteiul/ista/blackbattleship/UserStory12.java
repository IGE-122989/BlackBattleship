...
public class UserStory12 {
    ...
    public boolean hasSimpleMissileButton() {
        // Verificar se existe botão de míssil simples
        return !driver.findElements(By.xpath(
                "//*[contains(@class,'missile') or contains(@class,'simple') or " +
                        "contains(@data-icon,'rocket') or contains(@data-icon,'bomb')]")).isEmpty();
    }
}